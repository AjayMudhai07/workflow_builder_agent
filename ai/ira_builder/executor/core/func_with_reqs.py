...
def with_requirements(
    ...
    Example:
        ...
        .. code-block:: python
            ...
            import tempfile
            import asyncio
            from workflow_executor.nodes.python_executor import CodeBlock, PythonScriptExecutor
            from workflow_executor.nodes.python_executor.core.func_with_reqs import with_requirements
            import pandas
            ...
            async def run_example():
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    executor = PythonScriptExecutor(work_dir=temp_dir, functions=[load_data])
